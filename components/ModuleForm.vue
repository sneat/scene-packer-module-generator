...
export default {
  ...
  methods: {
    async generate () {
      ...
      try {
        const defaultModuleBuffer = await fetch('https://scene-packer-module-generator.fly.dev/https://github.com/sneat/starter-scene-packer/releases/latest/download/starter-scene-packer.zip')
